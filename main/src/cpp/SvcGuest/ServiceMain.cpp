...
#pragma __SERVICE_DEFSYMBOL_LINKPARAM(SERVICE_AUTOSTART)
#pragma __SERVICE_DEFSYMBOL_LINKPARAM(SERVICE_CRASHRESTART)
#pragma __SERVICE_DEFSYMBOL_LINKPARAM(SERVICE_RESTARTDELAY)
